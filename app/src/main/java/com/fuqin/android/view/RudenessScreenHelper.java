...
/**
 * Created by guoyang on 2018/1/13.
 * github https://github.com/GuoYangGit
 * QQ:352391291
 */

public class RudenessScreenHelper {
    private static float designWidth = 375;
    ...
    public static void resetDensity(Context context) {
        ...
        resources.getDisplayMetrics().density = size.x / designWidth;
        resources.getDisplayMetrics().scaledDensity = size.x / designWidth;

        DisplayMetrics metrics = getMetricsOnMiui(context.getResources());
        if (metrics != null) {
            metrics.scaledDensity = size.x / designWidth;
            metrics.density = size.x / designWidth;
        }
     ...
     */
    public RudenessScreenHelper(Application application) {
